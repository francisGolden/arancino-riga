...
export const useInventory = create<InventoryState>((set, get) => ({
  ...
  sellItem: async (id: string, cost: number) => {
    ...
    // const newInventory = currentInventory.filter((currentOwnedBusinessId: string) => currentOwnedBusinessId !== id)
  ...
  hydrateInventory: (savedInventory: Record<string, number>): void => set({ inventory: savedInventory }),
}))